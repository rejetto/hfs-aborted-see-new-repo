...
FileNode.prototype.containingFolderOf = function(child){
    return misc.sameFileName(this.resource, child.resource.substr(0, this.resource.length));
};

FileNode.prototype.getFolder = function(cb){
    var p = this.parent;
    return this.nodeKind === NK.TEMP && !p.containingFolderOf(this)
...
FileNode.prototype.testName = function(name) {
    ...
    return misc.caseSensitiveFileNames ? name === this.name : name.same(this.name);
}; // testName
